...
var ErrorOutput = (function () {
    ...
    ErrorOutput.prototype.reportInfo = function (info) {
        this._infoMessages.push(info.message);
    };
    ErrorOutput.prototype.reportError = function (error) {
        this._errorMessages.push(error);
    };
    Object.defineProperty(ErrorOutput.prototype, "info", {
        get: function () {
    ...
    Object.defineProperty(ErrorOutput.prototype, "errors", {
        get: function () {
...
var ConsoleErrorOutput = (function () {
...
var SqlConnection = (function () {
    function SqlConnection(parameters, listener) {
        var config = {
    ...
    SqlConnection.prototype.open = function (done) {
