...
/***/ function(module, exports, __webpack_require__) {
	...
	var Palavra = React.createClass({displayName: "Palavra",
	    ...
	    render: function() {
	        ...
	        var empty_or_token = ( token.length == 0 ) ? React.createElement("br", null) : token ;
	         
	        return React.createElement("span", {ref: "spamElem", className: classnames}, empty_or_token);
	    }
	...
	var TextSpace = React.createClass({displayName: "TextSpace",
	    ...
	    render: function() {
	        ...
	        var linhas = tokens.map(function(line,i) {
	            ...
	            return React.createElement(Linha, {key: i, tokens: tokens[i], selection: onlyIfSelected})
	        });
	        
	        return React.createElement("div", {className: "textspace", spellCheck: "false", onKeyPress: this.handlekey, onKeyDown: this.handleKeyDown, contentEditable: "true", onClick: this.handleclick}, linhas); 
	    }
	});
